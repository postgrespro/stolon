...
Set priority of keeper.

### Synopsis

Stolon will promote available keeper with higher priority than current master,
...
```
stolonctl setkeeperpriority [keeper uid] [priority] [flags]
```

### Options

```
  -h, --help   help for setkeeperpriority
```
